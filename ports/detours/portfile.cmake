...
# quick-fix or disable problematic samples so they at least don't prevent us from building withdll.exe example
foreach(SAMPLE echo talloc traceapi  tracebld  tracelnk  tracemem  tracereg  traceser  tracessl  tracetcp)
    vcpkg_replace_string("${SOURCE_PATH}/samples/Makefile" "\\${SAMPLE}\"" "\\syelog\"")
endforeach()
...
vcpkg_build_nmake(
   ...
   # CL_LANGUAGE NONE # stop overriding compiler flags
)
...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    file(INSTALL "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/bin.${VCPKG_TARGET_ARCHITECTURE}Release/" DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
endif()
